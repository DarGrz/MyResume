...
const Contact = () => {
  ...
  const onSubmit = (e) => {
    ...
    if (
      ...
      emailjs
        .send(
          "service_ilwzt1d", // service id
          "template_zkq87do", // template id
          mailData,
          "tMUx9HrYZ0a-q9-Hd" // public api
        )
        .then(
          (response) => {
            setError(false);
          ...
          <div className="col-md-12">
            <div className="section-title">
              ...
              <p className="text-uppercase small">
                Connect and Collaborate for Salesforce Opportunities
              </p>
            </div>
          </div>
        </div>
          ...
          <div className="col-lg-4 m-15px-tb">
            <div className="contact-info media box-shadow">
              ...
              <div className="media-body">
                ...
                <a target="_blank" href="https://goo.gl/maps/KoJe7n5Ag9goBZJ86">
                  Krakow, Poland
                </a>
              </div>
            </div>
            ...
            <div className="contact-info media box-shadow">
              ...
              <div className="media-body">
                ...
                <p>
                  <a href="mailto:d.grzegorczyk@outlook.com">
                    d.grzegorczyk@outlook.com
                  </a>
                  <br />
                </p>
              </div>
